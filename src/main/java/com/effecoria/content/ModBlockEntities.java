...
public final class ModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PhiMatcherBlockEntity>> PHI_MATCHER =
            BLOCK_ENTITY_TYPES.register(
                    "phi_matcher",
                    () -> BlockEntityType.Builder.of(PhiMatcherBlockEntity::new, ModBlocks.PHI_MATCHER.get())
                            .build(null));

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PhiIncubatorBlockEntity>> PHI_INCUBATOR =
            BLOCK_ENTITY_TYPES.register(
                    "phi_incubator",
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PhiWatchdogBlockEntity>> PHI_WATCHDOG =
            BLOCK_ENTITY_TYPES.register(
                    "phi_watchdog",
                    () -> BlockEntityType.Builder.of(PhiWatchdogBlockEntity::new, ModBlocks.PHI_WATCHDOG.get())
                            .build(null));

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<PhiFabricatorBlockEntity>> PHI_FABRICATOR =
            BLOCK_ENTITY_TYPES.register(
                    "phi_fabricator",
                    () -> BlockEntityType.Builder.of(
                                    PhiFabricatorBlockEntity::new,
                                    ModBlocks.PHI_FABRICATOR.get(),
                                    ModBlocks.PHI_FABRICATOR_II.get(),
