...
import com.effecoria.block.PhiCartographyTableBlock;
...
public final class ModBlocks {
    ...
    public static final DeferredBlock<PhiCartographyTableBlock> PHI_CARTOGRAPHY_TABLE = BLOCKS.register(
            "phi_cartography_table", () -> new PhiCartographyTableBlock(towerFacilityProps()));
    ...
    public static final DeferredBlock<PhiMatcherBlock> PHI_MATCHER = BLOCKS.register(
            "phi_matcher",
            () -> new PhiMatcherBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.SNOW)
                    .strength(2.5f, 6f)
                    .sound(SoundType.GLASS)
                    .requiresCorrectToolForDrops()
                    .lightLevel(s -> s.getValue(PhiMatcherBlock.POWERED) ? 9 : 3)));

    public static final DeferredBlock<PhiIncubatorBlock> PHI_INCUBATOR = BLOCKS.register(
            "phi_incubator",
            () -> new PhiIncubatorBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.COLOR_CYAN)
                    .strength(2.5f, 6f)
                    .sound(SoundType.METAL)
                    .requiresCorrectToolForDrops()
    ...
    public static final DeferredBlock<PhiWatchdogBlock> PHI_WATCHDOG = BLOCKS.register(
            "phi_watchdog",
            () -> new PhiWatchdogBlock(BlockBehaviour.Properties.of()
                    .mapColor(MapColor.COLOR_GRAY)
                    .strength(2.5f, 6f)
                    .sound(SoundType.STONE)
                    .requiresCorrectToolForDrops()
